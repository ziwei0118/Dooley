...
void read_adf(double a[][2], char address[], int nbin)
{
	/*a[theta, magnitude]*/
	int i;
	char line[100];
...
int main(void)
{
	...
	int N = 4913, nmove = 1000, fout = 10, k = 1000,oren = 50, acc_count = 0, natom = 0, num_cps = 0, num_shell = 0, nbin_rdf = 1600, nbin_adf = 750;
	...
	char directory_in[100] = "/Users/Ziwei/Desktop/INPUT/", open_name[100] ="w100.gro", directory_out[100] = "/Users/Ziwei/Desktop/jul_21_001/";
	FILE *fp_log;
