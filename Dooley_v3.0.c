...
//use the shell model, insertion of water in outer and inner shell are all based on actual potential
...
#define  RC_Sel_in 3.5 /*unit:A*/
#define  RC_Sel_out 4.4 /*unit:A*/
#define  ZH +0.417
#define  ZO -0.834
...
int main(void)
{
	...
	int N = 4913, nmove = 1400, fout = 20, k = 1000,oren = 10, acc_count = 0, natom = 0, num_cps = 0, num_shell = 0;
	...
	char directory_in[100] = "/Users/Ziwei/Desktop/INPUT/", open_name[100] ="water_out_30.gro", directory_out[100] = "/Users/Ziwei/Desktop/shell_3.1/";
	FILE *fp_log;
	clock_t start, finish;

	start = clock();
	printf("ProName:Dooley_v3.0  Job starts\n");
	n = frand();    /*discard the first random*/
	n = frand();
	sprintf(address_log, "%slog.txt", directory_out);
	fp_log = fopen(address_log, "w");
	fprintf(fp_log,"ProName:Dooley_v3.0     JOB STARTS\n");
